      ...
      <nav className='relative flex justify-between items-center lg:justify-start lg:gap-10' id='nav'>
        ...
        <div className='hidden lg:flex grow justify-between items-center text-[0.6rem]'>
          ...
          <div className='flex gap-4 items-center text-grayish-violet'>
            ...
            <button className='bg-cyan text-white px-3 py-1 rounded-full font-bold'>Sign Up</button>
          </div>
        </div>
      </nav>
    </>
