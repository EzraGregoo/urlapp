...
const Section = () => {
  return (
    <>
      <section className='pt-40 pb-20 bg-section px-5 py-10'>
      ...
      advanced<br/>statistics dashboard.</p>
          ...
          <article className='rounded-md text-center relative bg-white flex flex-col mt-24 pt-[75px] pb-8 w-full gap-4'>
            <div className='absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-full w-[85px] h-[85px] bg-dark-violet flex justify-center items-center'>
            ...
            <p className='text-gray text-base'>Boost your brand
      ...
      help<br/>instil confidence in your content.</p>
            <span className='bg-cyan w-2 h-[55px] absolute bottom-0 right-1/2 translate-x-1/2 translate-y-full'/>
          </article>
          <article className='rounded-md text-center relative bg-white flex flex-col mt-24 pt-[75px] pb-8 w-full gap-4'>
            <div className='absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-full w-[85px] h-[85px] bg-dark-violet flex justify-center items-center'>
            ...
            <p className='text-gray text-base'>Gain insights into
