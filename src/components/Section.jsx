...
const Section = ({isItem}) => {
  return (
    <>
      <article className={`${isItem?'pt-20':'pt-40'} pb-12 bg-section px-5 py-10 lg:pt-24 lg:px-12 lg:pb-56`}>
          <div className='text-center flex flex-col gap-3'>
              <h1 className='font-bold text-3xl lg:text-4xl'>Advanced Statistics</h1>
              <p className='text-grayish-violet lg:text-sm'>Track how your links are performing<br/>across the web with our
      advanced<br/>statistics dashboard.</p>
          </div>

          <div className='lg:flex lg:pt-8 flex-row justify-between relative'>

            <div className='rounded-md text-center relative bg-white flex flex-col mt-24 pt-[65px] pb-6 w-full gap-4 z-10 lg:w-auto lg:text-left  lg:px-5'>
              ...
              <p className='text-grayish-violet text-base lg:text-sm'>Boost your brand
        ...
        help<br/>instil confidence in your content.</p>
            ...
            <div className='rounded-md text-center relative bg-white flex flex-col mt-24 pt-[65px] pb-6 w-full gap-4 z-10 lg:w-auto lg:text-left lg:px-5 lg:translate-y-16'>
              <div className='absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-full w-[85px] h-[85px] bg-dark-violet flex justify-center items-center lg:left-0 lg:translate-x-5'>
              ...
              <p className='text-grayish-violet text-base lg:text-sm'>Gain insights into
        who is clicking<br/>your links. Knowing when and<br/>where people engage with your<br/>content helps inform better<br/>decisions.</p>
            ...
            <div className='rounded-md text-center relative bg-white flex flex-col mt-24 pt-[65px] pb-6 w-full gap-4 z-10 lg:w-auto lg:text-left lg:px-5 lg:translate-y-32'>
              <div className='absolute top-0 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-full w-[85px] h-[85px] bg-dark-violet flex justify-center items-center lg:left-0 lg:translate-x-5'>
              ...
              <p className='text-grayish-violet text-base lg:text-sm'>Improve brand
        awareness and<br/>content discoverability through<br/>customizable links,
        supercharging<br/>audience engagement.</p>
            </div>

            <span className='absolute bg-cyan w-2 h-full bottom-0 right-1/2 translate-x-1/2 lg:w-full lg:h-2 lg:bottom-12'/>
          </div>
      </article>
      <article className='relative text-white w-full h-[300px] bg-dark-violet py-28 px-5 flex flex-col justify-center items-center gap-6'>
        ...
        <button className='text-white rounded-full bg-cyan px-8 py-4 z-10 lg:text-sm lg:py-2 lg:px-4 lg:font-bold hover:backdrop-brightness-200'>Get started</button>
      </article> 
    </>
  )
}
